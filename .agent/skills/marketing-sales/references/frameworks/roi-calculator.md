# ROI Calculator Formulas and Formats

Input/output variable lists, Google Sheet layout specs, embedded calculator specs, and the in-meeting whiteboard script for building ROI calculations with prospect data.
