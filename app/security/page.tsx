		...
		<div className="min-h-screen bg-[#050505] text-white selection:bg-white/20 font-body flex flex-col relative overflow-hidden">
			...
			<main className="flex-1 flex flex-col items-center p-6 text-center relative z-10 mt-32 mb-20">
				...
				<p className="max-w-2xl mx-auto text-white/60 text-base md:text-lg leading-relaxed mb-16">
					Enterprise-grade security built into the foundation of your workspace.
					We take the protection of your code and conversations seriously.
				</p>
				...
				<div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto text-left">
					<div className="bg-white/5 border border-white/10 p-8 rounded-3xl">
						...
						<p className="text-white/60 leading-relaxed text-sm">
							...
							AES-256. Your sensitive API keys are stored securely using
					...
					<div className="bg-white/5 border border-white/10 p-8 rounded-3xl">
						...
						<p className="text-white/60 leading-relaxed text-sm">
							Our backend leverages secure, isolated environments for execution
							and storage. We adhere strictly to modern compliance and access
							control standards.
						</p>
					</div>
				</div>
