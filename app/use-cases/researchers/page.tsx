  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#07090c] text-white">
      <div className="max-w-2xl px-6 text-center">
        <h1 className="mb-6 text-4xl font-bold tracking-tight sm:text-5xl">For Researchers</h1>
        <p className="mb-8 text-lg text-white/70">
          Analyze data, summarize vast amounts of text, and organize findings effortlessly.
        </p>
        <Link 
          href="/"
