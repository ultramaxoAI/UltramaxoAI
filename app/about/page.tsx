  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-white/20 font-body flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 text-center relative z-10 mt-20">
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-heading italic tracking-tight mb-8">About Us</h1>
        <div className="max-w-2xl mx-auto space-y-6 text-white/60 text-base md:text-lg leading-relaxed">
          <p>We are a team of engineers, designers, and researchers building the next generation of intelligent workspaces.</p>
          <p>Ultramaxo AI was founded on the belief that AI should be integrated directly into where the work happens, not just act as a disposable chatbot.</p>
        </div>
      </main>
    </div>
  );
