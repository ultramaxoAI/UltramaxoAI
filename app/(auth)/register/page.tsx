		...
		<div className="flex min-h-screen w-full bg-black">
			...
			<div className="flex-1 flex items-center justify-center bg-black p-6 sm:p-10 lg:p-14 border-l border-white/10">
				<div className="w-full max-w-[420px] animate-in fade-in slide-in-from-right-4 duration-700 relative z-10">
					...
					{verificationSent ? (
						<div className="bg-white/5 p-8 rounded-2xl border border-white/10 text-center flex flex-col items-center gap-4">
							...
							<p className="text-zinc-500 text-xs italic bg-white/5 p-3 rounded-xl w-full border border-white/5">
