      ...
      >
        <div className="rounded-2xl border border-white/10 bg-[#0f0f15]/85 backdrop-blur-xl shadow-[0_30px_60px_-20px_rgba(0,0,0,0.65)] p-6 relative">
          <div className="flex items-center gap-3 mb-4 relative z-10">
            ...
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-zinc-500">Ultramaxo</p>
          ...
          <form onSubmit={handleResetPassword} className="space-y-3 relative z-10">
            <p className="text-xs text-zinc-400 mb-4">
              Masukkan password baru untuk akun kamu.
            </p>

            <label className="block space-y-1 text-sm text-zinc-300">
              <span className="text-[11px] uppercase tracking-wide text-zinc-500">Password Baru</span>
              <input
                type="password"
                value={newPassword}
              ...
              />
              <span className="text-[10px] text-zinc-500">Password minimal 6 karakter</span>
            </label>

            <label className="block space-y-1 text-sm text-zinc-300">
              <span className="text-[11px] uppercase tracking-wide text-zinc-500">Konfirmasi Password</span>
              <input
                type="password"
