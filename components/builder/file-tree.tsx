...
export default function FileTree() {
  ...
  return (
    <div className="w-64 border-r border-white/[0.06] bg-[#0a0a0a] flex flex-col h-full text-sm">
      <div className="p-3 border-b border-white/[0.06] flex items-center justify-between">
        ...
        <button 
          ...
          className="p-1 hover:bg-white/[0.04] rounded text-zinc-400 hover:text-zinc-200 transition-colors"
      ...
      <div className="flex-1 overflow-y-auto p-2">
        {isCreating && (
          <form onSubmit={handleCreateFile} className="mb-2 p-1.5 bg-zinc-900 border border-purple-500/20 rounded">
            <input
              autoFocus
              type="text"
              ...
              className="w-full bg-[#050505] border border-zinc-800 rounded px-2 py-1 text-xs text-white focus:outline-none focus:border-purple-500"
            />
            ...
            return (
              <div
                ...
                className={`group flex items-center justify-between px-2.5 py-1.5 rounded cursor-pointer transition-all duration-150 ${
                  isActive 
                    ? 'bg-purple-950/20 border-l-2 border-purple-500 text-white' 
