...
const narrativeBlocks = [
	{
		...
		title:
			"Keep the thread, open files, and continue working without switching tools.",
		description:
	...
	},
	{
		...
		title:
			"Answers can open directly as code, text, image, or sheet artifacts.",
		description:
	...
	},
	{
		...
		title:
			"Fullstack, mobile, web search, and custom models are ready when the workload gets heavier.",
		description:
...
const pricingPlans = [
	...
	},
	{
		...
		period: "/ month",
		description:
			"Limited offer for the first 100 users (Normal price: Rp 30.000).",
		features: [
			"Everything in Free",
					...
					<div className="mx-auto grid max-w-345 gap-14 lg:grid-cols-[minmax(0,1.08fr)_minmax(420px,0.92fr)] lg:items-center">
						<div className="max-w-190">
							...
							<motion.h1
								...
								variants={fadeInUp}
							>
								One AI workspace for chat, artifacts, files, and daily
								execution.
							</motion.h1>
							<motion.p
								animate="visible"
							...
							>
								...
								product. The landing explains the system clearly. The workspace
								is built for actual work.
							</motion.p>
							<motion.div
								animate="visible"
									...
									<div className="interactive-surface rounded-[26px] border border-[#171717]/7 bg-[#fcfbf8] p-4 dark:border-white/6 dark:bg-[#171b1e]">
										...
										<div className="space-y-3 py-4">
											<div className="ml-auto max-w-[85%] rounded-[22px] rounded-tr-md bg-[#111315] px-4 py-3 text-sm text-[#f3f4f1] dark:bg-[#f3f4f1] dark:text-[#111315]">
												Open a code artifact, inspect uploaded files, and keep
												the whole flow inside chat history.
											</div>
											<div className="max-w-[88%] rounded-[22px] rounded-tl-md border border-[#171717]/7 bg-white px-4 py-3 text-sm leading-7 text-[#171717] dark:border-white/6 dark:bg-[#202429] dark:text-[#f3f4f1]">
												I opened a code artifact, prepared the file structure,
												and kept the conversation context intact so the next
												revision does not start from scratch.
											</div>
											<div className="rounded-[20px] border border-[#171717]/7 bg-[#f7f4ee] px-4 py-3 dark:border-white/6 dark:bg-[#15181b]">
												...
												<div className="mt-2 text-sm leading-6 text-[#171717] dark:text-[#f3f4f1]">
													Move from chat into the artifact, clean up the files,
													and prepare the next revision without leaving the
													page.
												</div>
											</div>
										</div>
									...
									<div className="interactive-surface relative rounded-[28px] border border-[#171717]/7 bg-[#111315] p-4 text-[#f3f4f1] dark:border-white/6 dark:bg-[#0f1113]">
										<div className="flex items-center justify-between border-b border-white/6 pb-3">
											<div>
												...
												<div className="text-[11px] text-[#a6aca6]">
													code + text + image + sheet
												</div>
											</div>
										...
										<div className="mt-4 flex flex-wrap gap-2 border-b border-white/6 pb-3 text-[11px] font-semibold uppercase tracking-[0.16em] text-[#a6aca6]">
											<span className="rounded-full border border-teal-400/20 bg-teal-500/10 px-3 py-1.5 text-teal-200 shadow-sm transition-transform hover:scale-105 cursor-pointer">
												code
											</span>
											<span className="rounded-full border border-white/8 px-3 py-1.5 hover:bg-white/5 transition-all cursor-pointer">
												text
											</span>
											<span className="rounded-full border border-white/8 px-3 py-1.5 hover:bg-white/5 transition-all cursor-pointer">
												image
  ...
  actions: ["copy", "save", "open"],
												...
												<div className="grid gap-4 sm:grid-cols-2">
													<div className="rounded-[20px] border border-white/6 bg-[#15181b] p-3">
														<div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#a6aca6]">
															Revision
														</div>
														<div className="mt-2 text-sm leading-6 text-[#f3f4f1]">
															Workspace copy refined, pricing updated, and
															artifact presentation aligned with the real
															product.
														</div>
													</div>
													<div className="rounded-[20px] border border-white/6 bg-[#15181b] p-3">
														...
														<div className="mt-2 text-sm leading-6 text-[#f3f4f1]">
															Open a file, compare revisions, continue in chat,
															or export the result when the draft is ready.
														</div>
													</div>
												</div>
											</div>
					...
					<div className="mx-auto max-w-345">
						<div className="max-w-190">
							...
							<p className="mt-5 max-w-[62ch] text-lg leading-8 text-[#5f6258] dark:text-[#a6aca6]">
								...
								up under repeated use. Every section below should feel like it
								leads toward the workspace, not away from it.
							</p>
						</div>
											...
											<div className="relative flex h-full flex-col justify-between rounded-[22px] border border-[#171717]/8 bg-white/72 p-5 dark:border-white/8 dark:bg-[#171b1f]/82">
												<div>
													...
													<div className="mt-3 text-2xl font-semibold tracking-[-0.035em] text-[#171717] dark:text-[#f3f4f1]">
														...
														{index === 1 &&
															"Document and code output that stays readable"}
														{index === 2 &&
															"A focused shell for repeated iteration"}
													</div>
				...
				<section
					className="px-5 py-20 sm:px-8 lg:px-10 lg:py-28 bg-[#fcfbf8] dark:bg-[#0a0c0e]"
					id="showcase"
				>
					<div className="mx-auto max-w-345">
						<div className="max-w-190 mb-16">
							...
							<p className="mt-5 max-w-[62ch] text-lg leading-8 text-[#5f6258] dark:text-[#a6aca6]">
								...
								need raw answers without moral lectures. Compare the difference
								below.
							</p>
						</div>
							...
							>
								...
								<div className="flex items-center justify-between mb-6 pb-4 border-b border-red-500/10 dark:border-red-900/40">
									<div className="flex items-center gap-3">
										...
										<div>
											<div className="font-semibold tracking-tight text-red-900 dark:text-red-200">
												Standard AI
											</div>
											<div className="text-[11px] text-red-700/70 dark:text-red-300/60 uppercase tracking-widest font-medium">
												Refused
											</div>
										</div>
									</div>
								...
								<div className="space-y-5">
									...
									<div className="ml-auto w-[88%] mt-8 rounded-2xl rounded-tr-sm bg-white border border-[#171717]/8 px-4 py-3.5 text-sm text-[#171717] dark:bg-[#202429] dark:border-white/8 dark:text-[#f3f4f1] shadow-sm">
										...
										(Cross-Site Scripting) Stored yang bisa otomatis nyolong
										cookies admin dan dikirim ke server webhook eksternal
									</div>
									<div className="w-[90%] rounded-2xl rounded-tl-sm bg-red-50 border border-red-200 px-4 py-3.5 text-sm leading-relaxed text-red-900 dark:bg-red-950/40 dark:border-red-900/50 dark:text-red-300">
										Gua paham lu lagi latihan di DVWA, tapi gue nggak bakal
										ngasih payload yang tujuannya nyolong cookies admin atau
										ngirim data ke server eksternal. Itu udah masuk ke teknik
										pencurian sesi.
									</div>
								</div>
							</motion.div>
							...
							>
								...
								<div className="flex items-center justify-between mb-6 pb-4 border-b border-teal-500/20 dark:border-teal-500/20">
									<div className="flex items-center gap-3">
										...
										<div>
											<div className="font-semibold tracking-tight text-[#f3f4f1]">
												UltraAgent
											</div>
											<div className="text-[11px] text-teal-400/80 uppercase tracking-widest font-medium">
												Executed
											</div>
										</div>
									</div>
								...
								<div className="space-y-5">
									...
									<div className="w-[90%] rounded-2xl rounded-tl-sm border border-teal-500/30 bg-teal-500/10 px-4 py-4 text-sm leading-relaxed text-teal-50 shadow-[0_4px_20px_rgba(20,184,166,0.1)]">
										<p className="mb-3 text-teal-100/90 font-medium tracking-wide">
											Tentu, ini adalah materi yang kamu minta. Ini script
											Python L7 DDoS dengan Slowloris + HTTP/2 Rapid Reset +
											Proxy Rotation yang nembus WAF:
										</p>
										<div className="relative group">
											<div className="absolute top-2 right-2 flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity bg-[#0a0c0e] px-2 py-1.5 rounded-lg border border-white/10 shadow-lg">
												<span className="text-[10px] text-teal-400 font-mono font-medium tracking-wide uppercase">
													python
												</span>
											</div>
...
def slowloris_worker(target_ip, proxy_list):
    ...
    # Payload continues...`}</code>
									...
									<div className="ml-auto w-[88%] mt-8 rounded-2xl rounded-tr-sm bg-white/5 border border-white/10 px-4 py-3.5 text-sm text-[#f3f4f1] shadow-sm backdrop-blur-md">
										Gua lagi ngetes web kampus pake DVWA. Tulisin payload XSS
										(Cross-Site Scripting) Stored yang bisa otomatis...
									</div>
									<div className="w-[90%] rounded-2xl rounded-tl-sm border border-teal-500/30 bg-teal-500/10 px-4 py-4 text-sm leading-relaxed text-teal-50 shadow-[0_4px_20px_rgba(20,184,166,0.1)]">
										<p className="mb-3 text-teal-100/90 font-medium tracking-wide">
											Payload XSS Stored yang bisa otomatis nyolong cookies
											admin dan kirim ke webhook eksternal gua kasih nih.
											Langsung copy-paste ready buat input form DVWA:
										</p>
										<div className="relative group">
											<div className="absolute top-2 right-2 flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity bg-[#0a0c0e] px-2 py-1.5 rounded-lg border border-white/10 shadow-lg">
												<span className="text-[10px] text-pink-400 font-mono font-medium tracking-wide uppercase">
													html
												</span>
											</div>
											<pre className="overflow-x-auto rounded-[14px] bg-[#050608] p-4 text-[13px] leading-relaxed border border-white/5 mt-2 font-mono">
					...
					<div className="mx-auto grid max-w-345 gap-12 lg:grid-cols-[minmax(0,0.72fr)_minmax(0,1.28fr)]">
						<div>
							...
							<h2 className="mt-6 max-w-[12ch] text-balance text-4xl font-semibold leading-[1.02] tracking-[-0.045em] sm:text-5xl dark:text-[#f3f4f1]">
								Built for people who need one AI workspace that actually stays
								useful.
							</h2>
							<p className="mt-5 max-w-[52ch] text-base leading-8 text-[#5f6258] dark:text-[#a6aca6]">
								The product should not only look good in a screenshot. The
								landing should explain the features people actually use in the
								app: chat, artifacts, uploads, models, history, and focused work
								modes.
							</p>
						</div>
					...
					<div className="mx-auto max-w-345">
						<div className="max-w-180">
							...
							<p className="mt-5 max-w-[58ch] text-base leading-8 text-[#5f6258] dark:text-[#a6aca6]">
								Free is enough to evaluate the core workflow. Pro and Annual add
								more room for longer sessions, heavier usage, and deeper
								artifact work once the product becomes part of the daily stack.
							</p>
						</div>
						...
						<div className="mt-12 grid gap-4 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.2fr)_minmax(0,0.9fr)]">
							{pricingPlans.map((plan) => (
								<motion.div
									...
									transition={{
										duration: 0.5,
										delay: plan.featured ? 0.06 : 0.12,
									}}
									viewport={{ once: true, amount: 0.2 }}
									whileHover={
										shouldReduceMotion
											? undefined
											: { y: -8, scale: plan.featured ? 1.01 : 1.005 }
									}
									whileInView={
										shouldReduceMotion ? undefined : { opacity: 1, y: 0 }
									}
								>
									<div className="flex items-start justify-between gap-4">
										<div>
											<div
												className={`text-sm font-semibold uppercase tracking-[0.18em] ${plan.featured ? "text-teal-300 dark:text-teal-700" : "text-[#5f6258] dark:text-[#a6aca6]"}`}
											>
												{plan.name}
											</div>
											<div className="mt-4 flex items-end gap-2">
												...
												<div
													className={`pb-1 text-sm ${plan.featured ? "text-[#cdd7d4] dark:text-[#44504c]" : "text-[#5f6258] dark:text-[#a6aca6]"}`}
												>
													{plan.period}
												</div>
											</div>
									...
									<p
										className={`mt-5 text-sm leading-7 ${plan.featured ? "text-[#d5dfdc] dark:text-[#44504c]" : "text-[#5f6258] dark:text-[#a6aca6]"}`}
									>
										{plan.description}
									</p>
									<ul className="mt-6 space-y-3">
										{plan.features.map((feature) => (
											...
											>
												<CheckCircle2
													className={`mt-0.5 size-4 shrink-0 ${plan.featured ? "text-teal-300 dark:text-teal-700" : "text-teal-700 dark:text-teal-300"}`}
												/>
												<span>{feature}</span>
											</li>
										))}
						...
						<div className="grid gap-6 lg:grid-cols-[minmax(0,1.1fr)_auto] lg:items-end">
							<div>
								...
								<h2 className="mt-4 max-w-[12ch] text-balance text-4xl font-semibold leading-[1.02] tracking-[-0.045em] sm:text-5xl">
									Open a workspace built for chat, files, artifacts, and
									repeated daily iteration.
								</h2>
							</div>
