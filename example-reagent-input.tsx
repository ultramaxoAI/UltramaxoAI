    ...
    <div className="min-h-screen bg-app-bg flex items-center justify-center p-4">
      <div className="w-full max-w-3xl space-y-6">
        ...
        <div className="text-center">
          <h1 className="text-app-text text-3xl font-bold mb-2">Reagent.codes Style</h1>
          <p className="text-zinc-400 text-sm">Ultra Dark Theme - Minimalist Design</p>
        </div>

        {/* Example 1: Basic Rounded-Full Input */}
        <div className="bg-app-sidebar rounded-3xl p-6">
          <h2 className="text-app-text text-lg font-semibold mb-4">Basic Input (Rounded-Full)</h2>
        ...
        <div className="bg-app-sidebar rounded-3xl p-6">
          <h2 className="text-app-text text-lg font-semibold mb-4">Advanced Input (Multi-Action)</h2>
        ...
        <div className="bg-app-sidebar rounded-3xl p-6">
          <h2 className="text-app-text text-lg font-semibold mb-4">Floating Bottom Style</h2>
        ...
        <div className="bg-app-sidebar rounded-3xl p-6">
          <h2 className="text-app-text text-lg font-semibold mb-4">Compact Input</h2>
        ...
        <div className="bg-app-sidebar rounded-3xl p-6">
          <h2 className="text-app-text text-lg font-semibold mb-4">With Model Selector</h2>
        ...
        <div className="bg-app-sidebar rounded-3xl p-6">
          <h2 className="text-app-text text-lg font-semibold mb-4">Color Palette</h2>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            <div className="space-y-2">
              <div className="bg-app-bg h-16 rounded-xl border border-zinc-800"></div>
              <p className="text-xs text-zinc-400 text-center">app-bg<br/>#09090b</p>
            </div>
            <div className="space-y-2">
              <div className="bg-app-sidebar h-16 rounded-xl border border-zinc-800"></div>
              <p className="text-xs text-zinc-400 text-center">app-sidebar<br/>#18181b</p>
            </div>
            <div className="space-y-2">
              <div className="bg-app-input h-16 rounded-xl border border-zinc-800"></div>
              <p className="text-xs text-zinc-400 text-center">app-input<br/>#27272a</p>
            </div>
            <div className="space-y-2">
              <div className="bg-app-accent h-16 rounded-xl"></div>
              <p className="text-xs text-zinc-400 text-center">app-accent<br/>#6366f1</p>
            </div>
            <div className="space-y-2">
              <div className="bg-app-text h-16 rounded-xl"></div>
              <p className="text-xs text-zinc-400 text-center">app-text<br/>#f4f4f5</p>
            </div>
          </div>
        </div>
      </div>
